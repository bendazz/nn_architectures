(function() {
  const sendBtn = document.getElementById('sendBtnMulti');
  const travBias = document.getElementById('travBias');
  const trav1 = document.getElementById('trav1');
  const trav2 = document.getElementById('trav2');
  const travMerged = document.getElementById('travMergedMulti');

  const biasNode = document.getElementById('biasNode');
  const input1 = document.getElementById('input1');
  const input2 = document.getElementById('input2');
  const output = document.getElementById('outputMulti');

  const svg = document.getElementById('network-multi');
  const vb = svg.viewBox && svg.viewBox.baseVal ? svg.viewBox.baseVal : { x:0, y:0, width:600, height:260 };
